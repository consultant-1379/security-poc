...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-global" -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-internal" -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-name" -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-enm-kvstore-hc.name" . | quote }}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-container" -}}
{{- $g := fromJson (include "eric-enm-kvstore-hc.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enm-kvstore-hc.logshipper-default-value" .) }}
- name: "{{ include "eric-enm-kvstore-hc.logshipper-name" . }}-logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-enm-kvstore-hc.logshipper-image" . }}
  args:
  ...
  - name: SERVICE_ID
    value: {{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-enm-kvstore-hc.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-volume" -}}
{{- $g := fromJson (include "eric-enm-kvstore-hc.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enm-kvstore-hc.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-enm-kvstore-hc.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-enm-kvstore-hc.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-enm-kvstore-hc.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-enm-kvstore-hc.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-enm-kvstore-hc.product-info" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-enm-kvstore-hc.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-enm-kvstore-hc.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
  ...
  {{- else -}}
    ...
    {{- $default := merge $default (dict "images" (dict "logshipper" (dict "tag" "8.2.0-16" ))) -}}
  {{- end -}}
