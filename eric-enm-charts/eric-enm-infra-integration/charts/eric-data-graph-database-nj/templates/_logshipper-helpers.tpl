...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-global" -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-internal" -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-name" -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-data-graph-database-nj.name" . | quote }}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-data-graph-database-nj.LsSeccompProfile" -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-container" -}}
...
- name: "logshipper"
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-data-graph-database-nj.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-data-graph-database-nj.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-data-graph-database-nj.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-volume" -}}
{{- $g := fromJson (include "eric-data-graph-database-nj.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-graph-database-nj.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-data-graph-database-nj.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-data-graph-database-nj.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-data-graph-database-nj.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-data-graph-database-nj.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-data-graph-database-nj.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
...
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-data-graph-database-nj.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-data-graph-database-nj.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-data-graph-database-nj.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
