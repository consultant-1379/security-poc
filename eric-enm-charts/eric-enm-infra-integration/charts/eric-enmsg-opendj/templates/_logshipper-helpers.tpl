...
*/}}
{{- define "eric-enmsg-opendj.logshipper-global" -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-internal" -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-name" -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-enmsg-opendj.name" . | quote }}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-enmsg-opendj.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-enmsg-opendj.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-container" -}}
{{- $g := fromJson (include "eric-enmsg-opendj.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enmsg-opendj.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-enmsg-opendj.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-enmsg-opendj.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-enmsg-opendj.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-enmsg-opendj.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-enmsg-opendj.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-volume" -}}
{{- $g := fromJson (include "eric-enmsg-opendj.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enmsg-opendj.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-enmsg-opendj.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-enmsg-opendj.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-enmsg-opendj.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-enmsg-opendj.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-enmsg-opendj.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-enmsg-opendj.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-enmsg-opendj.product-info" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-enmsg-opendj.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-enmsg-opendj.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-enmsg-opendj.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
