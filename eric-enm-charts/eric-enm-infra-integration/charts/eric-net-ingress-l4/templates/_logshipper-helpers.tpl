...
*/}}
{{- define "eric-net-ingress-l4.logshipper-global" -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-internal" -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-name" -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-net-ingress-l4.name" . | quote }}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-container" -}}
{{- $g := fromJson (include "eric-net-ingress-l4.logshipper-global" .) }}
{{- $default := fromJson (include "eric-net-ingress-l4.logshipper-default-value" .) }}
- name: "{{ include "eric-net-ingress-l4.logshipper-name" .}}-logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-net-ingress-l4.logshipper-image" . }}
  args:
  ...
  - name: SERVICE_ID
    value: {{ include "eric-net-ingress-l4.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: "{{ include "eric-net-ingress-l4.logshipper-name" .}}-logshipper"
  livenessProbe:
    exec:
      command:
        - "/bin/bash"
  ...
  - name: "{{ include "eric-net-ingress-l4.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-net-ingress-l4.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-volume" -}}
{{- $g := fromJson (include "eric-net-ingress-l4.logshipper-global" .) }}
{{- $default := fromJson (include "eric-net-ingress-l4.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-net-ingress-l4.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-net-ingress-l4.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-net-ingress-l4.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-net-ingress-l4.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-net-ingress-l4.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
...
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-net-ingress-l4.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-net-ingress-l4.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-net-ingress-l4.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
