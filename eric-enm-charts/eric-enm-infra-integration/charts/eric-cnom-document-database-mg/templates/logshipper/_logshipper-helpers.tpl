...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-global" -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-internal" -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-name" -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-cnom-document-database-mg.name" . | quote }}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-container" -}}
{{- $g := fromJson (include "eric-cnom-document-database-mg.logshipper-global" .) }}
{{- $default := fromJson (include "eric-cnom-document-database-mg.logshipper-default-value" .) }}
- name: "logshipper"
  ...
  - name: SERVICE_ID
    value: {{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
    ...
    successThreshold: {{ $default.probes.logshipper.livenessProbe.successThreshold }}
  ...
  - name: "{{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-cnom-document-database-mg.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-volume" -}}
{{- $g := fromJson (include "eric-cnom-document-database-mg.logshipper-global" .) }}
{{- $default := fromJson (include "eric-cnom-document-database-mg.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-cnom-document-database-mg.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-cnom-document-database-mg.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-cnom-document-database-mg.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-cnom-document-database-mg.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-cnom-document-database-mg.product-info" . | nindent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-cnom-document-database-mg.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-cnom-document-database-mg.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
  ...
  {{- $default := merge $default (dict "probes" (dict "logshipper" (dict "livenessProbe" (dict "successThreshold" 1 )))) -}}
  ...
  {{- else -}}
    ...
    {{- $default := merge $default (dict "images" (dict "logshipper" (dict "tag" "7.1.0-22" ))) -}}
  {{- end -}}
