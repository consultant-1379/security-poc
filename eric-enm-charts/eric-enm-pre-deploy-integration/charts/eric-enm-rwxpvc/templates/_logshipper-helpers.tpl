...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-global" -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-internal" -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-name" -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-enm-rwxpvc.name" . | quote }}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-enm-rwxpvc.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-enm-rwxpvc.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-container" -}}
{{- $g := fromJson (include "eric-enm-rwxpvc.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enm-rwxpvc.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-enm-rwxpvc.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-enm-rwxpvc.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-enm-rwxpvc.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-enm-rwxpvc.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-enm-rwxpvc.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-volume" -}}
{{- $g := fromJson (include "eric-enm-rwxpvc.logshipper-global" .) }}
{{- $default := fromJson (include "eric-enm-rwxpvc.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-enm-rwxpvc.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-enm-rwxpvc.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-enm-rwxpvc.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-enm-rwxpvc.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-enm-rwxpvc.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-enm-rwxpvc.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-enm-rwxpvc.product-info" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-enm-rwxpvc.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-enm-rwxpvc.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-enm-rwxpvc.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
