...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-global" -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-internal" -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-name" -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-oss-ingress-controller-nx.name" . | quote }}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-container" -}}
{{- $g := fromJson (include "eric-oss-ingress-controller-nx.logshipper-global" .) }}
{{- $default := fromJson (include "eric-oss-ingress-controller-nx.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-oss-ingress-controller-nx.logshipper-image" . }}
  args:
  ...
  - name: SERVICE_ID
    value: {{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-oss-ingress-controller-nx.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-volume" -}}
{{- $g := fromJson (include "eric-oss-ingress-controller-nx.logshipper-global" .) }}
{{- $default := fromJson (include "eric-oss-ingress-controller-nx.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-oss-ingress-controller-nx.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-oss-ingress-controller-nx.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-oss-ingress-controller-nx.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-oss-ingress-controller-nx.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-oss-ingress-controller-nx.product-info" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-oss-ingress-controller-nx.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-oss-ingress-controller-nx.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
