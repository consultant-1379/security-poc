...
*/}}
{{- define "eric-ctrl-brocli.logshipper-global" -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-internal" -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-name" -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-ctrl-brocli.name" . | quote }}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-ctrl-brocli.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-ctrl-brocli.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-container" -}}
{{- $g := fromJson (include "eric-ctrl-brocli.logshipper-global" .) }}
{{- $default := fromJson (include "eric-ctrl-brocli.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-ctrl-brocli.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-ctrl-brocli.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-ctrl-brocli.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-ctrl-brocli.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-ctrl-brocli.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-volume" -}}
{{- $g := fromJson (include "eric-ctrl-brocli.logshipper-global" .) }}
{{- $default := fromJson (include "eric-ctrl-brocli.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-ctrl-brocli.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-ctrl-brocli.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-ctrl-brocli.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-ctrl-brocli.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-ctrl-brocli.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-ctrl-brocli.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-ctrl-brocli.product-info" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-ctrl-brocli.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-ctrl-brocli.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-ctrl-brocli.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
