...
/**
 * CRLValidationException occurs when the Exception is thrown when CRL input data validation fails
 *
 * @author xjagcho
 */
@ApplicationException(rollback = true) 
public class CRLValidationException extends RuntimeException {
     ...
     */
    public CRLValidationException(final String message) {
        super(message);
    }

    /**
     * Constructs a new CRLValidationException with cause
     * 
     * @param cause
    ...
    /**
     * Constructs a new CRLValidationException with detailed message and cause
     * 
     * @param errorMessage
