...
/**
 * This class Tests SignatureValidator
 */
...
public class SignatureValidatorTest {
    ...
    private SignerInformation signerInformation = null;
    ...
    public void setUp() {
        ...
        signerInformation = pkcs7ScepRequestData.getSignerInformation();
        publicKey = pkcs7ScepRequestData.getPublicKey();
    }

    /**
     * This method verifies signature of the given message
     */

    @Test
    public void testVerifySignature() {

        Assert.assertTrue(signatureValidator.validateSignature(signerInformation, publicKey));
