...
/**
 * This is an interface for MembershipListener class which is used to update the mastership status for the PKIRASCEP cluster every time there are membership changes in service cluster named
 * PKIRASCEPMastershipCluster
 * 
 * @author xnagsow
 *
 */
