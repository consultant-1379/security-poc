...
public class CaCertificatesResourceListenerTest {

    @InjectMocks
    CaCertificatesResourceListener caCertificatesResourceListener;
    ...
    public void testOnEvent() throws SecurityException, IllegalAccessException {
        ...
        ReflectionTestUtils.setPrimitiveField(CaCertificatesResourceListener.class, ServiceFinderBean.class, "serviceFinder", caCertificatesResourceListener, serviceFinderBean);
        when(serviceFinderBean.find(CmpCertificatesLocalService.class)).thenReturn(cmpCertificatesLocalService);

        caCertificatesResourceListener.onEvent(fileResourceEvent);

        Mockito.verify(cmpCertificatesLocalService).initializeCaCertificates();
    }

    @Test
    public void testGetURI() {
        Assert.assertNull(caCertificatesResourceListener.getURI());
    }

    @Test
    public void testGetEventTypes() {
        Assert.assertNull(caCertificatesResourceListener.getEventTypes());
    }
}
