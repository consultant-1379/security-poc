...
public class InvalidInitialConfigurationException extends ProtocolException {
    ...
    /**
     * This exception is thrown whenever a custom exception regarding invalid initial configuration needs to be wrapped over any java security exceptions or any 3pp exceptions
     * 
     * @param errorMessage
     *            It is a user defined errorMessage
     * @param cause
