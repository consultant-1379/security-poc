...
/**
 * This class handles Initialization Request. When this request is received, it needs to be validated for Header/Body, CRL and DigitalSignature.<br>
 ...
 * InitializationRequestHandler will persist the RequestMessage into DB, sign the Request message and dispatch the request onto Modeled event bus to PKI-Manager for Certificate generation.
 *
 * 
 * @author tcsdemi
 *
