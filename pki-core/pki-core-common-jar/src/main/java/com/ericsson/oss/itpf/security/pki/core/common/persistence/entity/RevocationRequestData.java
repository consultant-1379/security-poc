...
public class RevocationRequestData {
    ...
    private EntityInfoData entity;

    @ManyToOne(fetch = FetchType.LAZY, cascade = { CascadeType.REFRESH })
    @JoinColumn(name = "ca_entity_id", referencedColumnName = "id", nullable = true)
    private CertificateAuthorityData caEntity;
    ...
    private Set<CertificateData> certificatesToRevoke = new HashSet<>();

    /**
     * @return the entityId
     */
    public EntityInfoData getEntity() {
        return entity;
    }
     ...
     *            the entityId to set
     */
    public void setEntity(final EntityInfoData entity) {
        this.entity = entity;
    }
     ...
     * @return the issuerId
     */
    public CertificateAuthorityData getCaEntity() {
        return caEntity;
    }
     ...
     *            the issuerId to set
     */
    public void setCaEntity(final CertificateAuthorityData caEntity) {
