...
@ApplicationScoped
public class CertificatemanagementEserviceProxy {

    @EServiceRef
    private CertificateManagementService coreCertificateManagementService;

    public CertificateManagementService getCoreCertificateManagementService() {
        return coreCertificateManagementService;
    }
