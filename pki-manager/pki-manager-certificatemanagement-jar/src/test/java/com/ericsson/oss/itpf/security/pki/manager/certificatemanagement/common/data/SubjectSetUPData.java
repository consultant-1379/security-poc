...
public class SubjectSetUPData {
    ...
    public Subject getSubject_v1(final String commonName, final String organizationUnit, final String dc) {
        ...
        final SubjectField subjectField_dc = new SubjectField();
        subjectField_dc.setType(SubjectFieldType.DC);
        subjectField_dc.setValue(dc);
        subjectFields.add(subjectField_dc);
