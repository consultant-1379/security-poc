...
/**
 * This class validates Certificate Profile CAIssuer for a {@link CertificateProfile}
 */
public class CAIssuerValidator implements CommonValidator<CertificateProfile> {
    ...
    public <ValidationException extends PKIBaseException> void validate(final CertificateProfile certificateProfile) throws ValidationException {
        ...
        validateCAIssuer(issuerName);

    }

    private void validateCAIssuer(final CAEntity issuer) throws CANotFoundException, InvalidCAException, ProfileServiceException {
        ...
        if (caEntity == null) {
            ...
            throw new CANotFoundException(ProfileServiceErrorCodes.ERR_GIVEN_ISSUER + ProfileServiceErrorCodes.ERR_NOT_FOUND);
        }
