...
import com.ericsson.oss.itpf.security.pki.manager.service.validator.caentity.CaEntityCertificateExpiryNotificationDetailsValidator;

@RunWith(MockitoJUnitRunner.class)
public class CaEntityCertificateExpiryNotificationDetailsValidatorTest {

    @InjectMocks
    CaEntityCertificateExpiryNotificationDetailsValidator abstractEntityValidator;

    @Spy
    Logger logger = LoggerFactory.getLogger(CaEntityCertificateExpiryNotificationDetailsValidator.class);
