...
public class CaEntitySANValidatorTest {

    @Spy
    final Logger logger = LoggerFactory.getLogger(CaEntitySANValidator.class);
    ...
    /**
     * Method to test validate method in negative scenario. When Invalid SAN is provided to validate.
     */
    @Test(expected = InvalidSubjectAltNameExtension.class)
    public <T extends AbstractSubjectAltNameFieldValue> void testWrongSAN() {
        ...
        caEntity.getCertificateAuthority().setSubjectAltName(subjectAltName);

        caEntitySANValidator.validate(caEntity);

    }

    /**
     * Method to test validate method in negative scenario. When SAN is provided with null Valve.
     */
    @Test(expected = InvalidSubjectAltNameExtension.class)
    public void testSANInEntityProfileNull() {

        caEntityData.getEntityProfileData().setSubjectAltName(null);
    ...
    /**
     * Method to test validate method in positive scenario. When SAN is provided with Empty Valve.
     */
    @Test
    public void testSANEmpty() {

        caEntity.getCertificateAuthority().getSubjectAltName().setSubjectAltNameFields(new ArrayList<SubjectAltNameField>());
    ...
    /**
     * Method to test validate method in negative scenario. When entitiesPersistenceHandler returning empty Entity data.
     */
