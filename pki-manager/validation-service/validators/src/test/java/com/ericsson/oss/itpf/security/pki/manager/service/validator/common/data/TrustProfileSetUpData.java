...
public class TrustProfileSetUpData {
    ...
    private TrustCAChainSetupData trustCAChainSetupData;
    ...
    private void fillTrustProfile() {
        ...
        for (TrustCAChain trustCAChain : trustCAChains) {
    ...
    private List<ExtCA> fillExtCA() {
        ...
        CertificateAuthority certAuth = new CertificateAuthority();
        certAuth.setName("External CA 1");
        extCA.setCertificateAuthority(certAuth);
        List<ExtCA> extCAs = new ArrayList<ExtCA>();
        extCAs.add(extCA);
        return extCAs;
    }
    ...
    private void fillTrustProfileData() {
        ...
        for (TrustCAChainData trustCAChainData : trustCAChainDatas) {
