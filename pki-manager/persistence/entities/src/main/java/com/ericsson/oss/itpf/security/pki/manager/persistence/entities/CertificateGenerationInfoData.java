...
public class CertificateGenerationInfoData implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "SEQ_CERTIFICATE_GENERATION_INFO_ID_GENERATOR", sequenceName = "SEQ_CERTIFICATE_GENERATION_INFO_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CERTIFICATE_GENERATION_INFO_ID_GENERATOR")
    @Column(name = "id")
    private long id;
    ...
    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ca_entity_info", nullable = true)
    private CAEntityData cAEntityInfo;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "issuer_ca", nullable = true)
    private CAEntityData issuerCA;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "entity_info", nullable = true)
    private EntityData entityInfo;

    @OneToOne(fetch = FetchType.LAZY, cascade = { CascadeType.PERSIST })
    @JoinColumn(name = "certificate_request_id", nullable = true)
     ...
     */
    public CAEntityData getcAEntityInfo() {
        return cAEntityInfo;
    }
     ...
     */
    public void setcAEntityInfo(final CAEntityData cAEntityInfo) {
     ...
     * @return the issuerCA
     */
    public CAEntityData getIssuerCA() {
        return issuerCA;
    }
     ...
     *            the issuerCA to set
     */
    public void setIssuerCA(final CAEntityData issuerCA) {
     ...
     */
    public EntityData getEntityInfo() {
        return entityInfo;
    }
     ...
     */
    public void setEntityInfo(final EntityData entityInfo) {
    ...
    public String toString() {
        return "CertificateGenerationInfoData [certificateVersion=" + certificateVersion + ", skewCertificateTime=" + skewCertificateTime + ", validity=" + validity + ", subjectUniqueIdentifier="
                + subjectUniqueIdentifier + ", issuerUniqueIdentifier=" + issuerUniqueIdentifier + ", keyGenerationAlgorithmData=" + keyGenerationAlgorithmData + ", signatureAlgorithmData="
                + signatureAlgorithmData + ", issuerSignatureAlgorithmData=" + issuerSignatureAlgorithmData + ",requestType=" + requestType + ", certificateExtensionsJSONData="
                + certificateExtensionsJSONData + ", cAEntityInfo=" + cAEntityInfo + ", issuerCA=" + issuerCA + ", entityInfo=" + entityInfo + ", certificateRequestData=" + certificateRequestData
                + ", certificateData=" + certificateData + ", forExternalCA=" + forExternalCA + ",subjectUniqueIdentifierValue=" + subjectUniqueIdentifierValue + "]";
