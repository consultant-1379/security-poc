...
public class CertificateData implements Serializable {
    ...
    @Column(name = "published_to_tdps", nullable = false)
    private boolean publishedToTDPS = false;
    ...
    /**
     * Sets current timestamp to createdDate and modifiedDate before persist of Certificate in DB
     */
    @PrePersist
    ...
    /**
     * Sets current timestamp to modifiedDate before update of Certificate in DB
     */
    @PreUpdate
     ...
     */
    public void setStatus(final Integer certificateStatus) {
    ...
    /**
     * @return the publishedToTDPS
     */
    public boolean isPublishedToTDPS() {
        return publishedToTDPS;
    }

    /**
     * @param publishedToTDPS
     *            the publishedToTDPS to set
     */
    public void setPublishedToTDPS(final boolean publishedToTDPS) {
        this.publishedToTDPS = publishedToTDPS;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + (publishedToTDPS ? 1231 : 1237);
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (this.isPublishedToTDPS() != other.isPublishedToTDPS()) {
            return false;
        }
    ...
    public String toString() {
        return "CertificateData [id=" + id + ", " + (null != serialNumber ? "serialNumber=" + serialNumber + ", " : "") + (null != notBefore ? "notBefore=" + notBefore + ", " : "")
                ...
                + (null != issuerCA ? "issuerCA=" + issuerCA.getCertificateAuthorityData().getName() + ", " : "") + (null != subjectDN ? "subjectDN=" + subjectDN + ", " : "")
                + (null != subjectAltName ? "subjectAltName=" + subjectAltName + ", " : "") + "]" + (null != subjectAltName ? "subjectAltName=" + subjectAltName + ", " : "")
                + (null != issuerCertificate ? "issuerCertificate=" + issuerCertificate + ", " : "") + (null != revokedTime ? "revokedDate=" + revokedTime + ", " : "") + "is published to TDPS"
                + publishedToTDPS + "]";
    }
}