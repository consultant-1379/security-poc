...
public class CrlGenerationInfoData implements Serializable {
    ...
    private Set<CertificateData> caCertificate = new HashSet<CertificateData>();
    ...
    /**
     * @return the signatureAlgorithmId
     */
     ...
     *            the signatureAlgorithmId to set
     */
    public void setSignatureAlgorithmId(final AlgorithmData signatureAlgorithmId) {
        this.signatureAlgorithm = signatureAlgorithmId;
    }
    ...
    public String toString() {
        return "CrlGenerationInfoData [id=" + id + ", validityPeriod=" + validityPeriod + ", skewCrlTime=" + skewCrlTime + ", overlapPeriod=" + overlapPeriod + ", version=" + version
                + ", crlExtensions=" + crlExtensionsJSONData + ", signatureAlgorithmId=" + signatureAlgorithm + ", caCertificate=" + caCertificate + "]";
    }
