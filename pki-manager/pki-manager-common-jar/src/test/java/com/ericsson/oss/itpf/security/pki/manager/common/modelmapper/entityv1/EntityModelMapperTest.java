...
public class EntityModelMapperTest {
    ...
    @Spy
    final Logger logger = LoggerFactory.getLogger(EntityModelMapperTest.class);

    @InjectMocks
    EntityModelMapper entityMapper;

    @Mock
    CAEntityModelMapper caEntityMapper;
    ...
    public void testToAPIModel() throws Exception {
        ...
        final Entity entity = entityMapper.toApi(entityData, MappingDepth.LEVEL_0);
    ...
    public void testToAPIModelNull() throws Exception {
        ...
        entityMapper.toApi(null, MappingDepth.LEVEL_1);
    ...
    public void testToAPIModelEmpty() throws Exception {
        ...
        entityMapper.toApi(new EntityData(), MappingDepth.LEVEL_1);
    ...
    public void testToAPIModelWrongType() throws Exception {
        ...
        entityMapper.toApi(new CAEntityData(), MappingDepth.LEVEL_1);
    ...
    public void testFromAPiModel() {
        ...
        final EntityData entityData1 = entityMapper.fromApi(entity);
    ...
    public void testFromAPiModelEmpty() throws Exception {
        ...
        entityMapper.fromApi(new Entity());
    ...
    public void testFromAPiModelWrongType() throws Exception {
        ...
        entityMapper.fromApi(new CAEntity());
