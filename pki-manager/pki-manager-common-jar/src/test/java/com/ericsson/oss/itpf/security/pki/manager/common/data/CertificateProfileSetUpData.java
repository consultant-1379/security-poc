...
public class CertificateProfileSetUpData {
    ...
    public SubjectKeyIdentifier getSubjectKeyIdentifier() {
        ...
        final Algorithm keyIdentifierAlgorithm = getAlgorithm(AlgorithmType.SIGNATURE_ALGORITHM);
        final List<AlgorithmCategory> categories = new ArrayList<AlgorithmCategory>();
        categories.add(AlgorithmCategory.KEY_IDENTIFIER);
        keyIdentifierAlgorithm.setCategories(categories);
