...
/**
 * Class that registers serializer for {@link CertificateAuthority} class
 * 
 * @author tcspred
 * 
 */
public class IssuerFetchSerializer extends JsonSerializer<CertificateAuthority> {
    ...
    public void serialize(final CertificateAuthority certificateAuthority, final JsonGenerator generator, final SerializerProvider provider) throws IOException, JsonProcessingException {
        ...
        generator.writeObjectField("id", certificateAuthority.getId());
        generator.writeObjectField("name", certificateAuthority.getName());
