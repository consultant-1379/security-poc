...
public class EndEntityProfileResourceTest {
    ...
    public void testFetch() throws DatatypeConfigurationException, URISyntaxException, IOException {
        ...
        final EntityProfile entityProfile = entityProfileSetUpToTest.getEntityProfile();
        final ObjectMapperUtilTest testObjectMapperUtil = new ObjectMapperUtilTest();

        final Profiles profiles = new Profiles();
        final List<EntityProfile> entityProfilesList = new ArrayList<EntityProfile>();
        ...
        request = MockHttpRequest.get("/endentityprofile/fetch");
