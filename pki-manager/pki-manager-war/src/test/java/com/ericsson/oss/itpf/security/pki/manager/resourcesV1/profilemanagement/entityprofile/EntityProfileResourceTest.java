...
public class EntityProfileResourceTest {
    ...
    public void testGetProfile() throws Exception {
        ...
        request = MockHttpRequest.get("/1.0/entityprofile/load/1");
    ...
    public void testUpdateProfile() throws Exception {
        ...
        request = MockHttpRequest.put("/1.0/entityprofile/update");
    ...
    public void testSaveProfile() throws Exception {
        ...
        request = MockHttpRequest.post("/1.0/entityprofile/save");
        request.contentType(MediaType.APPLICATION_JSON);
        request.content(getJsonFromObject(entityProfile).getBytes("UTF-8"));
        dispatcher.invoke(request, response);
