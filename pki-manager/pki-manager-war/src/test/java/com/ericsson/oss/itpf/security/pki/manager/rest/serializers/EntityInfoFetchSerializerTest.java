...
/**
 * Test class for {@link EntityInfoFetchSerializer}
 * 
 * @author tcspred
 * @version 1.1.30
 */
public class EntityInfoFetchSerializerTest {

	@Mock
	EntityInfoFetchSerializer entityInfoFetchSerializer;
	...
	public void testSerialize() throws JsonProcessingException, IOException {
		...
		final String expectedJsonEntityCategory = "{\"id\":1,\"name\":\"ENMService\",\"otpcount\":5,\"otp\":null,\"status\":\"NEW\",\"subject\":{\"subjectFields\":[{\"type\":\"COMMON_NAME\",\"value\":\"ENM_Root\"}]},\"subjectAltName\":{\"@class\":\".SubjectAltName\",\"critical\":false,\"subjectAltNameFields\":[{\"type\":\"DIRECTORY_NAME\",\"value\":{\"@class\":\".SubjectAltNameString\",\"value\":\"www.xyz.com\"}}]},\"certificateAssigned\":0}";
