...
/**
 * Test class for {@link TrustedCASerializer}
 * 
 * @author tcspred
 * @version 1.1.30
 */
@RunWith(MockitoJUnitRunner.class)
public class TrustedCASerializerTest {

	@Mock
	TrustedCASerializer trustedCASerializer;
	...
	public void testSerialize() throws JsonProcessingException, IOException {
		...
		final String expectedJsonEntityCategory = "{\"id\":3,\"name\":\"TestCA\"}";

		trustedCASerializer.serialize(caEntity, generator, provider);
