...
/**
 * A utility class for the tests to load the relevant {@link ObjectMapper} for objects.
 * 
 * @author xnagcho
 * @version 1.2.4
 * 
...
public class ObjectMapperUtilTest {
    ...
    private ObjectMapper commonMapper, accessMethodMapper, keyPurposeIdMapper, certificateMapper, keyUsageTypeMapper, extendedKeyUsageTypeMapper, reasonFlagsMapper, subjectAltNameFieldTypeMapper,
            ...
            keyGenerationAlgorithmSerializerMapper, subjectAltNameExtensionMapper, subjectCapabilitiesMapper, entitiesFetchMapper, entityMapper, entityCategoryMapper, entityFetchMapper,
            entityDeserializerMapper, caEntityFetchMapper, caEntityDeserializerMapper, certificateModelMapper, issuerFetchMapper, certificateProfileFetchMapper, trustProfileFetchMapper,
            revocationReasonDeserializerMapper;

    private final static String INVALID_MAPPER_TYPE = "Invalid mapper type!";

    public ObjectMapperUtilTest() throws IOException {
    ...
    public ObjectWriter getCertficateSerializerMapper(final Set<String> detailsFilterProperties) {
        ...
        final ObjectMapper certificateModelMapper = getCertficateModelSerializerMapper();
