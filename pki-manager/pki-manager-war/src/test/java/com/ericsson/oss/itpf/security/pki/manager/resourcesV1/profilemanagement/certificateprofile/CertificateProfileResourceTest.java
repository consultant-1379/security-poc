...
public class CertificateProfileResourceTest {
    ...
    public void testGetProfile() throws Exception {
        ...
        request = MockHttpRequest.get("/1.0/certificateprofile/load/123");
    ...
    public void testUpdateProfile() throws Exception {
        ...
        request = MockHttpRequest.put("/1.0/certificateprofile/update");
    ...
    public void testSaveProfile() throws Exception {
        ...
        request = MockHttpRequest.post("/1.0/certificateprofile/save");
        request.contentType(MediaType.APPLICATION_JSON);
        request.content(JsonUtil.getJsonFromObject(certificateProfile).getBytes("UTF-8"));
        dispatcher.invoke(request, response);
    ...
    public void testFetchProfiles() throws DatatypeConfigurationException, URISyntaxException, IOException {
        ...
        request = MockHttpRequest.get("/1.0/certificateprofile/fetch");
