...
/**
 * Test class for {@link CertificateAuthorityDeserializer}
 * 
 * @author tcspred
 * @version 1.1.30
 */
public class CertificateAuthorityDeserializerTest {

	@Mock
	CertificateAuthorityDeserializer certificateAuthorityDeserializer;
	...
	public void setUp() {
		...
		module.addDeserializer(CertificateAuthority.class,
				new CertificateAuthorityDeserializer());
	...
	public void testCertificateAuthoritySerialize()
		...
		final String inputJsonCertificateAuthority = "{\"id\":1,\"name\":\"TestCA\",\"active\":true,\"subject\":{\"subjectFields\":[{\"type\":\"COMMON_NAME\",\"value\":\"ENM_Root\"}]},\"subjectAltName\":{\"@class\":\".SubjectAltName\",\"critical\":false,\"subjectAltNameFields\":[{\"type\":\"DIRECTORY_NAME\",\"value\":{\"@class\":\".SubjectAltNameString\",\"value\":\"www.xyz.com\"}}]}}";

		final CertificateAuthority expectedCertificateAuthority = mapper.readValue(
				inputJsonCertificateAuthority, CertificateAuthority.class);

		assertEquals(expectedCertificateAuthority.getId(),
				certificateAuthority.getId());
		assertEquals(expectedCertificateAuthority.getName(),
				certificateAuthority.getName());
		assertEquals(expectedCertificateAuthority.getStatus(),
				certificateAuthority.getStatus());
		assertEquals(expectedCertificateAuthority.getSubject(),
				certificateAuthority.getSubject());
		assertEquals(expectedCertificateAuthority.getSubjectAltName(),
				certificateAuthority.getSubjectAltName());
	}
