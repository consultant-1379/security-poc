...
public class TrustProfileResourceTest {
    ...
    public void testGetProfile() throws Exception {
        ...
        request = MockHttpRequest.get("/1.0/trustprofile/load/1");
    ...
    public void testUpdateProfile() throws Exception {
        ...
        request = MockHttpRequest.put("/1.0/trustprofile/update");
    ...
    public void testSaveProfile() throws Exception {
        ...
        request = MockHttpRequest.post("/1.0/trustprofile/save");
        request.contentType(MediaType.APPLICATION_JSON);
        request.content(getJsonFromObject(trustProfile).getBytes("UTF-8"));
        dispatcher.invoke(request, response);
    ...
    public void testFetch() throws Exception {
        ...
        request = MockHttpRequest.get("/1.0/trustprofile/fetch");
        dispatcher.invoke(request, response);
