...
/**
 * Test class for {@link CertificateAuthorityFetchSerializer}
 * 
 * @author tcspred
 * @version 1.1.30
 */
public class CertificateAuthorityFetchSerializerTest {

    @Mock
    CertificateAuthorityFetchSerializer certificateAuthorityFetchSerializer;
     ...
     */
    @Test
    public void testCertificateAuthorityFetchSerialize() throws JsonProcessingException, IOException {

        final String expectedJsonEntityCategory = "{\"id\":1,\"name\":\"TestCA\",\"status\":\"ACTIVE\",\"subject\":{\"subjectFields\":[{\"type\":\"COMMON_NAME\",\"value\":\"ENM_Root\"}]},\"subjectAltName\":{\"@class\":\".SubjectAltName\",\"critical\":false,\"subjectAltNameFields\":[{\"type\":\"DIRECTORY_NAME\",\"value\":{\"@class\":\".SubjectAltNameString\",\"value\":\"www.xyz.com\"}}]},\"certificateAssigned\":0}";
