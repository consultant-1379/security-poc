...
import com.ericsson.oss.itpf.security.pki.manager.service.schedular.common.data.EntityCategorySetUpData;
...
/**
 * This class is used to prepare the entities data.
 */
public class EntitiesSetUpData {
    ...
    private final CAEntity caEntity;
    private final CAEntityData caEntityData;

    private ExtCA extCA;
    private CAEntityData extCAData;

    private final List<CAEntityData> caEntityDataList = new ArrayList<CAEntityData>();
    private final List<CAEntity> caEntityList = new ArrayList<CAEntity>();

    private final EntityProfileData entityProfileData;
    private final CertificateProfileData certificateProfileData;
    private final Set<CertificateProfileData> certificateProfileDatas;

    private final Map<String, Object> entityInput = new HashMap<String, Object>();

    private final EntityCategorySetUpData entityCategorySetUpData;
