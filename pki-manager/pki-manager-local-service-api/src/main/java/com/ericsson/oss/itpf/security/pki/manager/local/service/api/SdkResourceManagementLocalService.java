...
/**
 * This interface is for providing centralized management of File operations in pki-manager using SDK Resource API .
 * 
 * @author tcsnapa
 * 
 */
@EService
@Local
public interface SdkResourceManagementLocalService {
    /**
     ...
     * @param absoluteFileURI
     *            Path where the file is located.An absolute URI to file resource.
     * @return name of the resource pointing to absoluteFileURI.
     */
    String getResource(final String absoluteFileURI);
     ...
     * @param absoluteFileURI
     *            Path where the file is located.An absolute URI to file resource.
     * @return true if the resource exist in the path absoluteFileURI or else otherwise.
     */
