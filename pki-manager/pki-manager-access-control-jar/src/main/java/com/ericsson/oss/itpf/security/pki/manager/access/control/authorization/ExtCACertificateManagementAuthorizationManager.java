 ...
 * 
 */
public class ExtCACertificateManagementAuthorizationManager {
     ...
     */
    public void authorizeExtCACertificateMgmtOperations(final ActionType actionType) {
        ...
        if (actionType != null) {
            ...
            logger.error("Invalid external CA operation: actionType is null");
            throw new IllegalArgumentException("Invalid external CA operation: actionType is null");
    ...
    /**
     * Method is used to authorize external CA name available check.
     */
