...
public class EnrollmentInfoSetUpData {
    ...
    private static final String EQUAL_IPV4_ENROLLMENT_URL = "EqualIpv4EnrollmentURL";
    private static final String NOT_EQUAL_IPV4_ENROLLMENT_URL = "NotEqualIpv4EnrollmentURL";
    private static final String EQUAL_IPV6_ENROLLMENT_URL = "EqualIpv6EnrollmentURL";
    private static final String NOT_EQUAL_IPV6_ENROLLMENT_URL = "NotEqualIpv6EnrollmentURL";
    ...
    public EnrollmentInfo getEnrollmentInfoForEqual() {
        ...
        enrollmentInfo.setIpv4EnrollmentURL(EQUAL_IPV4_ENROLLMENT_URL);
        enrollmentInfo.setIpv6EnrollmentURL(EQUAL_IPV6_ENROLLMENT_URL);
        return enrollmentInfo;
    }
    ...
    public EnrollmentInfo getEnrollmentInfoForNotEqual() {
        ...
        enrollmentInfo.setIpv4EnrollmentURL(NOT_EQUAL_IPV4_ENROLLMENT_URL);
        enrollmentInfo.setIpv6EnrollmentURL(NOT_EQUAL_IPV6_ENROLLMENT_URL);
        return enrollmentInfo;
    }
}
