...
/**
 * This exception is thrown when the invalid authority key identifier is provided as part of the request.
 */
public class InvalidAuthorityKeyIdentifierExtension extends CertificateExtensionException {

    private static final long serialVersionUID = 3437722274270495304L;

    /**
     * Constructs a new InvalidAuthorityKeyIdentifierExtension
     */
    public InvalidAuthorityKeyIdentifierExtension() {
        super();
    }
     ...
     */
    public InvalidAuthorityKeyIdentifierExtension(final String message) {
        super(message);
    }
     ...
     */
    public InvalidAuthorityKeyIdentifierExtension(final Throwable cause) {
        super(cause);
    }
     ...
     *            the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
    public InvalidAuthorityKeyIdentifierExtension(final String message, final Throwable cause) {
        super(message, cause);
    }
