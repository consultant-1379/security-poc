...
public class AlgorithmNotFoundException extends AlgorithmException {
    ...
    /**
     * Constructs a new AlgorithmNotFoundException
     */
    ...
    /**
     * Constructs a new AlgorithmNotFoundException with detailed message
     * 
     * @param message
    ...
    /**
     * Constructs a new AlgorithmNotFoundException with cause
     * 
     * @param cause
     *            the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
    public AlgorithmNotFoundException(final Throwable cause) {
        super(cause);
    }

    /**
     * Constructs a new AlgorithmNotFoundException with detailed message and cause
     * 
     * @param message
     ...
     *            the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
    public AlgorithmNotFoundException(final String message, final Throwable cause) {
        super(message, cause);
    }
