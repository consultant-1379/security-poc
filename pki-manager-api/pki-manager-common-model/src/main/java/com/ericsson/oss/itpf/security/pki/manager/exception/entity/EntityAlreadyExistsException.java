...
public class EntityAlreadyExistsException extends EntityException {
    ...
    /**
     * Constructs a new EntityAlreadyExistsException with detailed message
     * 
     * @param errorMessage
    ...
    /**
     * Constructs a new EntityAlreadyExistsException with cause
     * 
     * @param cause
    ...
    /**
     * Constructs a new EntityAlreadyExistsException with detailed message and cause
     * 
     * @param errorMessage
    ...
    public EntityAlreadyExistsException(final String errorMessage, final Throwable cause) {
