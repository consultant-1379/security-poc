...
public class EntityNotFoundException extends EntityException {
    ...
    /**
     * Constructs a new EntityNotFoundException with detailed message
     * 
     * @param errorMessage
    ...
    /**
     * Constructs a new EntityNotFoundException with cause
     * 
     * @param cause
    ...
    /**
     * Constructs a new EntityNotFoundException with detailed message and cause
     * 
     * @param errorMessage
    ...
    public EntityNotFoundException(final String errorMessage, final Throwable cause) {
