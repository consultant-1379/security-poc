...
public class OtpExpiredException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = 6477244513453006050L;
    ...
    public OtpExpiredException(final String message) {
        super("credential-manager-service-api: OtpExpired: " + message);
    }
    ...
    public OtpExpiredException(final String message, final Throwable cause) {
        super("credential-manager-service-api: OtpExpired: " + message, cause);
    }
