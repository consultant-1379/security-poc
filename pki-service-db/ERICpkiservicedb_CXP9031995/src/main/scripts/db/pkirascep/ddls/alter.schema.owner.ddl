...
BEGIN
    ...
    LOOP
        EXECUTE 'alter table '|| r.tablename ||' owner to pkirascepgrp;';
    END LOOP;
END$$;
...
BEGIN
    ...
    LOOP
        EXECUTE 'alter sequence '|| r.sequence_name ||' owner to pkirascepgrp;';
    END LOOP;
END$$;
...
BEGIN
    ...
    LOOP
        EXECUTE 'alter function '||r.schema_name||'.'||r.function_name||'('||r.function_arguments||') owner to pkirascepgrp;';
    END LOOP;
END$$;