...
#*******************************************************************************
#This function drops the pkimanagerdb database,if database exists in pg_database
#*******************************************************************************
function drop_db(){
...
EOF
    ...
    is_db_pkimanagerdb=`grep -i ${DB} ${DB_TEST}.${LDATE} | wc -l`

    if [ ${is_db_pkimanagerdb} -gt 0 ]; then
