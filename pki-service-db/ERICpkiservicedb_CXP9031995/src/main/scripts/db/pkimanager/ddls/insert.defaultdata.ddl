INSERT INTO algorithm_type(id,type) SELECT 1,'MESSAGE_DIGEST_ALGORITHM' WHERE NOT EXISTS (SELECT * FROM algorithm_type WHERE id=1);
INSERT INTO algorithm_type(id,type) SELECT 2,'SIGNATURE_ALGORITHM' WHERE NOT EXISTS (SELECT * FROM algorithm_type WHERE id=2);
INSERT INTO algorithm_type(id,type) SELECT 3,'ASYMMETRIC_KEY_ALGORITHM' WHERE NOT EXISTS (SELECT * FROM algorithm_type WHERE id=3);
INSERT INTO algorithm_type(id,type) SELECT 4,'SYMMETRIC_KEY_ALGORITHM' WHERE NOT EXISTS (SELECT * FROM algorithm_type WHERE id=4);
...
INSERT INTO entity_category(id,modifiable,name) SELECT 0,FALSE,'UNDEFINED' WHERE NOT EXISTS (SELECT * FROM entity_category WHERE id = 0);
