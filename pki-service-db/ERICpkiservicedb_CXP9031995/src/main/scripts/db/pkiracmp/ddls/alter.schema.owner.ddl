...
BEGIN
    ...
    LOOP
        EXECUTE 'alter table '|| r.tablename ||' owner to pkiracmpgrp;';
    END LOOP;
END$$;
...
BEGIN
    ...
    LOOP
        EXECUTE 'alter sequence '|| r.sequence_name ||' owner to pkiracmpgrp;';
    END LOOP;
END$$;
...
BEGIN
    ...
    LOOP
        EXECUTE 'alter function '||r.schema_name||'.'||r.function_name||'('||r.function_arguments||') owner to pkiracmpgrp;';
    END LOOP;
END$$;