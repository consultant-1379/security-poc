...
ALTER SEQUENCE IF EXISTS SEQ_REVOCATION_REQUEST_ID OWNER TO pkicore;
...
ALTER SEQUENCE IF EXISTS SEQ_CRL_GENERATION_INFO_ID OWNER TO pkicore;
...
(
  ...
  CONSTRAINT pk_crl_generationInfo_id PRIMARY KEY (id),
...
(
  ...
  certificate_id bigint NOT NULL,
  CONSTRAINT pk_crl_generation_info_certificate_id  PRIMARY KEY (crl_generation_info_id, certificate_id),
...
ALTER SEQUENCE IF EXISTS SEQ_CRL_ID OWNER TO pkicore;
...
ALTER SEQUENCE IF EXISTS SEQ_CRLINFO_ID OWNER TO pkicore;
...
(
  ...
  CONSTRAINT fk_certificate_id FOREIGN KEY (certificate_id)
      REFERENCES certificate (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fk_crl FOREIGN KEY (crl_id)
...
(
  ...
  CONSTRAINT pk_ca_crlinfo PRIMARY KEY (ca_id, crlinfo_id),
  CONSTRAINT fk_crlinfo_id FOREIGN KEY (crlinfo_id)
      REFERENCES crlinfo (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fk_certificate_authority_id FOREIGN KEY (ca_id)
      REFERENCES certificate_authority (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
