...
SELECT add_column_if_not_exists('certificate_authority', 'is_issuer_external_ca', 'ALTER TABLE IF EXISTS certificate_authority ADD COLUMN is_issuer_external_ca boolean DEFAULT false');
