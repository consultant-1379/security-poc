...
public class RevocationManagementRevokeCACertHandlerTest {

    @InjectMocks
    private RevocatioManagementRevokeCACertHandler revocationManagementRevokeCaCertHandler;
    ...
    @Spy
    private final Logger logger = LoggerFactory.getLogger(RevocatioManagementRevokeCACertHandler.class);
    ...
    private final String commandValue = "REVOCATIONMANAGEMENTREVOKECACERT";
    private String reasonTextValue = "keyCompromise";
    private String entityNameValue = "ENMServiceCA";
    ...
    public void setUp() {
        ...
        command.setCommandType(PkiCommandType.REVOCATIONMANAGEMENTREVOKECACERT);
        MockitoAnnotations.initMocks(revocationManagementRevokeCaCertHandler);
    ...
    public void testProcessCommand() {
        ...
        String expectedMsg = "Certificate with name:: ENMServiceCA revoked successfully";
        properties = getEntityNameProperties();
        command.setProperties(properties);
        final PkiMessageCommandResponse pkiCommandResponse = (PkiMessageCommandResponse) revocationManagementRevokeCaCertHandler.process(command);
    ...
    public void testProcessCommand_Throws_CertificateNotFoundException() {
        ...
        Mockito.doThrow(new CertificateNotFoundException(expectedMsg)).when(revocationService)
                .revokeCAEntityCertificates(Mockito.anyString(), (RevocationReason) Mockito.anyObject(), (Date) Mockito.anyObject());
        final PkiMessageCommandResponse pkiCommandResponse = (PkiMessageCommandResponse) revocationManagementRevokeCaCertHandler.process(command);
        Mockito.verify(commandHandlerUtils).getRevocationReason(command);
        Mockito.verify(commandHandlerUtils).getInvalidityDateInGmt(invaliditydate);
    ...
    public void testProcessCommandCAIdentifier() {
        ...
        properties = getSnoIssuerSubDnProperties();
        command.setProperties(properties);
    ...
    public void testProcessCommandDN() {
        ...
        String expectedMsg = "Certificate with subjectDN:: CN=Test, O=TCS revoked successfully";
    ...
    public void testProcessCommandCAIdentifierIssuerNameNull() {
        ...
        String expectedMsg = "Error: 11000 Issuer Name cannot be null or empty.";
        properties = getSnoIssuerSubDnProperties();
    ...
    @Test
    public void testProcessCommandSubjectDNNull() {

        String expectedMsg = "11000 Subject DN cannot be null or empty.";
        properties = getSubjectDnProperties();
        properties.put(subjectDNKey, "");
        command.setProperties(properties);
    ...
    public void testProcessCertificateNotFoundException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new CertificateNotFoundException("Failed Generation"));
    ...
    public void testProcessEntityNotFoundException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new EntityNotFoundException("Failed Generation"));
    ...
    public void testProcessExpiredCertificateException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new ExpiredCertificateException("Failed Generation"));
    ...
    public void testProcessIssuerNotFoundException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new IssuerNotFoundException("Failed Generation"));
    ...
    public void testProcessRevokedCertificateException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new RevokedCertificateException("Failed Generation"));
    ...
    public void testProcessRevocationServiceException() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new RevocationServiceException("Failed Generation"));
    ...
    public void testProcessCommandInvalidityDateWrongFormat() {
        ...
        String expectedMsg = "11607 Invalid argument: Date format error.Supported Format is yyyy-MM-dd HH:mm:ss";
        properties = getSnoIssuerSubDnProperties();
        command.setProperties(properties);

        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new IllegalAttributeException("Date format Not supported "));
        final PkiMessageCommandResponse pkiCommandResponse = (PkiMessageCommandResponse) revocationManagementRevokeCaCertHandler.process(command);
    ...
    public void testProcessCommandRevocationReasonInvalidCode() {
        ...
        Mockito.when(revocationManagementRevokeCaCertHandler.process(command)).thenThrow(new IllegalArgumentException("Reason not supported"));
    ...
    public void testProcessCommand_SecurityViolationException() {
        ...
        Mockito.doThrow(SecurityViolationException.class).when(revocationService).revokeCAEntityCertificates("ENMServiceCA", RevocationReason.KEY_COMPROMISE, null);
        revocationManagementRevokeCaCertHandler.process(command);
    }
    ...
    private Map<String, Object> getSnoIssuerSubDnProperties() {

        Map<String, Object> properties = new HashMap<String, Object>();

        properties.put(commandKey, commandValue);
        properties.put(reasonTextKey, reasonTextValue);
        properties.put(issuerNameKey, issuerNameValue);
        properties.put(serialNoKey, serialNoValue);
