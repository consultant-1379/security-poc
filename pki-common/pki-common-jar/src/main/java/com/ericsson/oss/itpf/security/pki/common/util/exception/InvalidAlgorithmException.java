...
/**
 * This Exception will be thrown if invalid algorithm is provided for performing Cryptographic operations.
 * 
 * @author xjagcho
 * 
 */
...
public class InvalidAlgorithmException extends RuntimeException {
    ...
    public InvalidAlgorithmException(final Throwable cause) {
        super(cause);
    }
    ...
    public InvalidAlgorithmException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
