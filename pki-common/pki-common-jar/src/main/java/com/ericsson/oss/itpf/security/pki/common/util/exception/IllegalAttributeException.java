...
/**
 * This Exception will be thrown when there is any invalid attribute found during PKCS10CertificationRequest parsing.
 * 
 * @author xjagcho
 * 
 */
...
public class IllegalAttributeException extends RuntimeException {
    ...
    public IllegalAttributeException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
