...
public class ExtendedKeyUsageSetUpData {
     ...
     * @return OtherName
     */
    public ExtendedKeyUsage getExtendedKeyUsageForEqual(final boolean isCritical) {
        ...
        extendedKeyUsage.setCritical(isCritical);
     ...
     * @return OtherName
     */
    public ExtendedKeyUsage getExtendedKeyUsageForNotEqual(final boolean isCritical) {
        final ExtendedKeyUsage extendedKeyUsage = new ExtendedKeyUsage();
        final List<KeyPurposeId> keyPurposeIdList = new ArrayList<KeyPurposeId>();
