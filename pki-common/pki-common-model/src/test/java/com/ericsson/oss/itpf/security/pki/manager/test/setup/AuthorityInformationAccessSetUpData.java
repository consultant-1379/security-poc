...
public class AuthorityInformationAccessSetUpData {
     ...
     */
    public AuthorityInformationAccess getAuthorityInformationAccessForEqual(final boolean isCritical) {
        ...
        authorityInformationAccess.setCritical(isCritical);
        return authorityInformationAccess;
    }
     ...
     * @return AuthorityInformationAccess
     */
    public AuthorityInformationAccess getAuthorityInformationAccessForNotEqual(final boolean isCritical) {
        final AuthorityInformationAccess authorityInformationAccess = new AuthorityInformationAccess();
        final List<AccessDescription> accessDescriptionList = new ArrayList<AccessDescription>();
