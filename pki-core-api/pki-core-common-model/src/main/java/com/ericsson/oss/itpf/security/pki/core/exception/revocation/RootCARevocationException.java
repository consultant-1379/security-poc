...
public class RootCARevocationException extends RevocationException {
     ...
     */
    public RootCARevocationException(final String errorMessage) {
        super(errorMessage);
    }
     ...
     */
    public RootCARevocationException(final Throwable cause) {
        super(cause);
    }
     ...
     *            the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
    public RootCARevocationException(final String errorMessage, final Throwable cause) {
