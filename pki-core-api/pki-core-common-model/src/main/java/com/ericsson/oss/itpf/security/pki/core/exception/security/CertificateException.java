...
/**
 * Base exception for all certificate related exceptions.
 */
public class CertificateException extends CoreSecurityException {

    private static final long serialVersionUID = 482007842369632761L;

    /**
     * Constructs a new CertificateException
     */
