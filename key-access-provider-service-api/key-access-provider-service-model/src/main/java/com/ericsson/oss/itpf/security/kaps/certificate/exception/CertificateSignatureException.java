...
public class CertificateSignatureException extends CertificateException {
    ...
    private static final long serialVersionUID = 3940626553404196793L;

    /**
     * Constructs a new CertificateSignException with detailed message
     *
     * @param message
    ...
    /**
     * Constructs a new CertificateSignException with cause
     *
     * @param cause
    ...
    /**
     * Constructs a new CertificateSignException with detailed message and cause
     *
     * @param message
