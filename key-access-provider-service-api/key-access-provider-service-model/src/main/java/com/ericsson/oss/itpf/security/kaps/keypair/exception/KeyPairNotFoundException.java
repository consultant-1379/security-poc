...
/**
 * This exception is thrown when the keys are not found.
 * 
 * @author xramcho
 * 
 **/
public class KeyPairNotFoundException extends KeyPairException {
     ...
     */
    public KeyPairNotFoundException(final String errorMessage) {
        super(errorMessage);
    }
     ...
     *            the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
    public KeyPairNotFoundException(final String errorMessage, final Throwable cause) {
